...
| service\_attachment | PSC service attachment configuration. | <pre>object({<br>    nat_subnets                      = list(string)<br>    automatic_accept_all_connections = optional(bool)<br>    consumer_accept_lists            = optional(list(string))<br>    consumer_reject_lists            = optional(list(string))<br>    description                      = optional(string)<br>    domain_name                      = optional(string)<br>    enable_proxy_protocol            = optional(bool)<br>    reconcile_connections            = optional(bool)<br>  })</pre> | `null` | no |
| subnets | Optional: A map containing subnet details Used to derive the subnetwork URI if subnetwork is not provided. | <pre>list(object({<br>    id                               = string<br>    name                             = optional(string)<br>    region                           = string<br>    project                          = optional(string)<br>    network                          = optional(string)<br>    purpose                          = string<br>    role                             = optional(string)<br>    state                            = optional(string)<br>    self_link                        = optional(string)<br>    ip_cidr_range                    = optional(string)<br>    gateway_address                  = optional(string)<br>    private_ip_google_access         = optional(bool)<br>    private_ipv6_google_access       = optional(string)<br>    subnetwork_id                    = optional(number)<br>    creation_timestamp               = optional(string)<br>    stack_type                       = optional(string)<br>    ipv6_access_type                 = optional(string)<br>    ipv6_cidr_range                  = optional(string)<br>    external_ipv6_prefix             = optional(string)<br>    internal_ipv6_prefix             = optional(string)<br>    ipv6_gce_endpoint                = optional(string)<br>    fingerprint                      = optional(string)<br>    description                      = optional(string)<br>    reserved_internal_range          = optional(string)<br>    send_secondary_ip_range_if_empty = optional(bool)<br>    ip_collection                    = optional(string)<br>    secondary_ip_range               = optional(any)<br>    log_config                       = optional(any)<br>    params                           = optional(any)<br>    timeouts                         = optional(any)<br>  }))</pre> | `[]` | no |
